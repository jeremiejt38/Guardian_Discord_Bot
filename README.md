...
[![Version](https://img.shields.io/badge/version-v0.19.10-blue?style=flat-square)](https://github.com/jeremiejt38/Guardian_Discord_Bot/releases)
...
|---------|------|---------|
| **v0.19.10** | 2026-07-07 | Fix: step 3 — icône ✅/❌ conservée sur le slot actif + curseur ▶ affiché après l'icône ← *actuel* |
