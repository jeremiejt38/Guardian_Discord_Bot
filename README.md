...
| Version | Description |
|---------|-------------|
| **v0.23** | **release**: auto-backport version bump to beta and dev after release · **release**: exclude tests/, e2e/, docs/E2E_CHECKLIST from free zip (kept in repo for contributors) · **build**: add .freeignore support, copy public docs to bundle, add anti-leak premium check · **premium**: add hosting plans (premium/trial/free_hosted/lifetime), getLicense logic, updated SQL schema · **premium**: document complete SaaS license architecture (activation, expiration, bidirectional migration) · **release**: add detailed commit body on private repo + patch list on free repo commit · **updater**: point changelog/releases links to public free repo instead of private repo · **release**: don't retag free repo — GitHub API already creates the tag · **release**: push full stripped source bundle to free repo via git instead of file-by-file API · **build**: exclude node_modules/data from free bundle, generate .gitignore · add complete workflow schema (branches, release, free bundle, issues, PRs) · add architecture, database schema, premium model, dev-setup, testing, deploy-hetzner · bump version to 0.23.10 · clean root — move docs to docs/, remove aider artifacts · **release**: auto-update README on free repo at each release · **release**: exclude .env, node_modules and data from free zip · legal: add proprietary LICENSE, CONTRIBUTING CLA, SECURITY policy + auto-push to free repo on release · **release**: add free bundle build + GitHub Free release publishing · Discord native settings integration — AFK timeout, system channel, locale sync, Community rules/updates/description, AutoMod rules, Onboarding (step 2/4/8) · README generator — scripts/readme-data.js + generate-readme.js, full rebuild from structured data · invite mode — 3 modes (classic/strict/direct) replace invite_grade_enabled + invite_strict_mode · new options notifier — DM guild owner on update with unconfigured settings from new version · guides toggle in setup step 2 — optional feature, enabled by default · **Community onboarding & invite modes** — 3 invite modes (Classic / Strict / Direct member), `#devenir-membre` ephemeral flow (prerequisites + bio modal + submit), `#rejoindre-notre-serveur` (server stats, Guardian features, owner presentation), strict invite mode blocks vocal + `#general` for guests, rules acceptance (Discord Screening + button for non-community), Discord AutoMod→behavior score integration, server guides (read-only channels or forums), new options notifier on update (DM owner with unconfigured settings) |
| | [Full diff](https://github.com/jeremiejt38/Guardian_Discord_Bot/compare/v0.23.15...v0.23.16) [Full diff](https://github.com/jeremiejt38/Guardian_Discord_Bot/compare/v0.23.14...v0.23.15) [Full diff](https://github.com/jeremiejt38/Guardian_Discord_Bot/compare/v0.23.13...v0.23.14) [Full diff](https://github.com/jeremiejt38/Guardian_Discord_Bot/compare/v0.23.12...v0.23.13) [Full diff](https://github.com/jeremiejt38/Guardian_Discord_Bot/compare/v0.23.11...v0.23.12) [Full diff](https://github.com/jeremiejt38/Guardian_Discord_Bot/compare/v0.23.9...v0.23.11) [Full diff](https://github.com/jeremiejt38/Guardian_Discord_Bot/compare/v0.23.9...v0.23.10) [Full diff](https://github.com/jeremiejt38/Guardian_Discord_Bot/compare/v0.23.8...v0.23.9) [Full diff](https://github.com/jeremiejt38/Guardian_Discord_Bot/compare/v0.23.5...v0.23.8) [Full diff](https://github.com/jeremiejt38/Guardian_Discord_Bot/compare/v0.22.1...v0.23.5) |
